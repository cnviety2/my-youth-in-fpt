...
public class UserHomeController extends HttpServlet {
    ...
    private final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(UserHomeController.class);
    ...
    public void init() throws ServletException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserHomeController.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            logger.error("Error at UserHomeController:" + ex.toString());
        } finally {
