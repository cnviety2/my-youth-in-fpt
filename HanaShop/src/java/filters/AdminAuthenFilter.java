 ...
 * @author Admin
 */
@WebFilter(filterName = "AdminAuthenFilter", urlPatterns = "/admin/*")
public class AdminAuthenFilter implements Filter {

    //Filter này để check role của người dùng,nếu không phải role admin sẽ hủy session chuyển về trang login
