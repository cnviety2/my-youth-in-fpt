...
public class SearchCarServlet extends HttpServlet {
    ...
    private final Logger logger = Logger.getLogger(SearchCarServlet.class);
    ...
    public void init() throws ServletException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchCarServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
