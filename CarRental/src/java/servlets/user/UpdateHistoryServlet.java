...
public class UpdateHistoryServlet extends HttpServlet {
    ...
    private final Logger logger = Logger.getLogger(UpdateHistoryServlet.class);
    ...
    public void init() throws ServletException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateHistoryServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean flag = historyDAO.updateHistoryByIDS(id);
            if (flag) {
                String email = ((User) session.getAttribute("USER")).getEmail();
                List<ViewHistoryDTO> listHistory = historyDAO.getHistoryByEmail(email);
                ...
                message = "Huy thue xe chua thanh cong";
            }

        } catch (NullPointerException e) {
            message = "Loi null pointer";
            logger.error("Error at UpdateHistory:" + e.toString());
        } catch (Exception e) {
