...
public class ConfirmAccountServlet extends HttpServlet {
    ...
    private final Logger logger = Logger.getLogger(ConfirmAccountServlet.class);
    ...
    public void init() throws ServletException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfirmAccountServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String message = "";
        String url = "/user/confirm-failed.jsp";
        try {
            if (session != null) {
                User user = (User) session.getAttribute("USER");
                String email = user.getEmail();
                RegistrationDAO dao = new RegistrationDAO();
                boolean flag = dao.updateConfirmedUser(email);
                if (flag) {
                    url = "/user/confirm-success.jsp";
                }
            }
