...
public class ViewHistoryServlet extends HttpServlet {
    ...
    private final Logger logger = Logger.getLogger(ViewHistoryServlet.class);
    ...
    public void init() throws ServletException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewHistoryServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            logger.error("Error at ViewHistoryServlet:" + e.toString());
        } catch (Exception e) {
